...
const routes = {
  ...
  clientProfile: (email: string) => `http://portal.vtexcommercestable.com.br${baseURL}/pub/profiles?email=${email}`,
  createTransaction: (account: string, transactionId: string) =>
    `https://${account}.vtexpayments.com.br/api/pvt/transactions/${transactionId}/payments`,
}
...
export class Checkout extends JanusClient {
  ...
  public clientProfile(
    ...
    return this.http.get(
      routes.clientProfile(email),
      getRequestConfigKey(mket)
    )
  }
